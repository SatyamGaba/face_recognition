...
class CustomLoss(nn.Module):
    ...
    def forward(self, input, target):
        ...
        # IMPLEMENT loss
        cos_theta_s = self.s * cos_theta
        phi_theta_s = self.s * phi_theta
        
        index = cos_theta_s.data * 0.0 #size=(B,Classnum)
        index.scatter(1,target.data.view(-1,1),1)
        index = index.byte()
        index = Variable(index)

        output = cos_theta_s #size=(B,Classnum)
        output[index] -= cos_theta_s[index]
        output[index] += phi_theta_s[index]
        ...
        _, predictedLabel = torch.max(cos_theta_s.data, 1)
...
class faceNet(nn.Module):
    ...
    def forward_with_normalization(self, x):
        x = self.relu1_1(self.norm1_1(self.conv1_1(x)))
        x = x + self.relu1_3(self.norm1_3(self.conv1_3(self.relu1_2(self.norm1_2(self.conv1_2(x))))))

        x = self.relu2_1(self.norm2_1(self.conv2_1(x)))
        x = x + self.relu2_3(self.norm2_3(self.conv2_3(self.relu2_2(self.norm2_2(self.conv2_2(x))))))
        x = x + self.relu2_5(self.norm2_5(self.conv2_5(self.relu2_4(self.norm2_4(self.conv2_4(x))))))

        x = self.relu3_1(self.norm3_1((self.conv3_1(x))))
        x = x + self.relu3_3(self.norm3_3(self.conv3_3(self.relu3_2(self.norm3_2(self.conv3_2(x))))))
        x = x + self.relu3_5(self.norm3_5(self.conv3_5(self.relu3_4(self.norm3_4(self.conv3_4(x))))))
        x = x + self.relu3_7(self.norm3_7(self.conv3_7(self.relu3_6(self.norm3_1(self.conv3_6(x))))))
        x = x + self.relu3_9(self.norm3_9(self.conv3_9(self.relu3_8(self.norm3_8(self.conv3_8(x))))))

        x = self.relu4_1(self.norm4_1(self.conv4_1(x)))
        x = x + self.relu4_3(self.norm4_3(self.conv4_3(self.relu4_2(self.norm4_2(self.conv4_2(x))))))
